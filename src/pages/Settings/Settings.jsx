...
import { User, Phone, Mail, Key, FileText, Shield } from 'lucide-react';
      ...
      <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.2rem' }}>
        ...
        <div style={{
          ...
          <h3 style={{ margin: '0 0 1rem 0', fontSize: '0.875rem', fontWeight: 600, color: 'var(--text-secondary)' }}>
            <User size={16} style={{ display: 'inline', marginRight: '0.4rem' }} />
            Dados Pessoais
          </h3>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.8rem' }}>
            ...
            <div>
              <label style={{ fontSize: '0.8rem', fontWeight: 500, color: 'var(--text-secondary)', display: 'block', marginBottom: '0.3rem' }}>
                <Phone size={14} style={{ display: 'inline', marginRight: '0.2rem' }} />
                Telefone
              </label>
              <input
                name="phone"
            ...
            <div>
              <label style={{ fontSize: '0.8rem', fontWeight: 500, color: 'var(--text-secondary)', display: 'block', marginBottom: '0.3rem' }}>
                <Mail size={14} style={{ display: 'inline', marginRight: '0.2rem' }} />
                E-mail
              </label>
              <input
                value={formData.email}
                disabled
                style={{ ...inputStyle, background: 'var(--bg-tertiary)', cursor: 'not-allowed' }}
              />
            </div>
          </div>
        </div>
        ...
        <div style={{
          ...
          <h3 style={{ margin: '0 0 1rem 0', fontSize: '0.875rem', fontWeight: 600, color: 'var(--text-secondary)' }}>
            <Key size={16} style={{ display: 'inline', marginRight: '0.4rem' }} />
            Segurança
          </h3>
          <button
            type="button"
